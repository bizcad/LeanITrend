...
namespace QuantConnect.Indicators
{
    ...
    public class CyclePeriod : WindowIndicator<IndicatorDataPoint>
    {
        ...
        private readonly RollingWindow<decimal> _cycle;
        private readonly RollingWindow<decimal> _quadrature;
        private readonly RollingWindow<decimal> _deltaPhase;

        private readonly ExponentialMovingAverage _instPeriod;
        private readonly ExponentialMovingAverage _period;
