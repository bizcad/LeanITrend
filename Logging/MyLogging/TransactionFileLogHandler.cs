...
namespace QuantConnect.Logging
{
    ...
    /// </summary>
    public class TransactionFileLogHandler : ILogHandler
    {
        ...
        public TransactionFileLogHandler(string filepath)
        {
        ...
        /// </summary>
        public TransactionFileLogHandler()
            : this("transactions.csv")
        {
            if (File.Exists("transactions.csv"))
                File.Delete("transactions.csv");
        }
